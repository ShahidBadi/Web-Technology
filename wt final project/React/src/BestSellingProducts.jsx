...
//   // Function to calculate the original price based on a 20% discount
//   const calculateOriginalPrice = (discountedPrice) => {
//     return (discountedPrice / 0.8).toFixed(2); // 20% discount means the discounted price is 80% of the original price
//   };
...
//                                 <a href="#" className="btn btn-primary rounded-1 p-2 fs-7 btn-cart flex-grow-1">
//                                   <img
//                                     src={cart}
//                                     alt="Cart Icon"
//                                     width={18}
